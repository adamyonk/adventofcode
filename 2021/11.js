...
// `
    ...
    const getAdjacent = (index) => {
      ...
      const northEast = north !== undefined && east ? north + 1 : undefined;
      const southEast = south && east ? south + 1 : undefined;
      const southWest = south && west ? south - 1 : undefined;
      const northWest = north && west ? north - 1 : undefined;
    ...
    for (let i = 0; i < 100; i++) {
      ...
      const test = TEST[i + 1];
      if (test && test !== pl(part1)) {
        console.log(i + 1);
        console.log(pl(part1));
      }
    }
    console.log("part 1:", part1.flashes);
    // < 1694

    // console.log("part 1:", getAdjacent(0));
